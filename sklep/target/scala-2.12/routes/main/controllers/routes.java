...
public class routes {
  ...
  public static final controllers.ReverseBrandController BrandController = new controllers.ReverseBrandController(RoutesPrefix.byNamePrefix());
  ...
  public static final controllers.ReverseProductCategoryController ProductCategoryController = new controllers.ReverseProductCategoryController(RoutesPrefix.byNamePrefix());
  ...
  public static final controllers.ReverseShipperController ShipperController = new controllers.ReverseShipperController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseBrandController BrandController = new controllers.javascript.ReverseBrandController(RoutesPrefix.byNamePrefix());
    ...
    public static final controllers.javascript.ReverseProductCategoryController ProductCategoryController = new controllers.javascript.ReverseProductCategoryController(RoutesPrefix.byNamePrefix());
    ...
    public static final controllers.javascript.ReverseShipperController ShipperController = new controllers.javascript.ReverseShipperController(RoutesPrefix.byNamePrefix());
